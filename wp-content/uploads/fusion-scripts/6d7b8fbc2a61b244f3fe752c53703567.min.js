...
! function(t, e) {
    var a = function(t, e, a) {
        ...
        var r = e.documentElement,
            ...
            E = (F = [], R = [], D = F, H = function() {
                var t = D;
                for (D = F.length ? R : F, T = !0, k = !1; t.length;) t.shift()();
                T = !1
            }, I = function(t, a) {
                T && !a ? t.apply(this, arguments) : (D.push(t), k || (k = !0, (e.hidden ? l : d)(H)))
            }, I._lsFlush = H, I),
            _ = function(t, e) {
                return e ? function() {
                    E(t)
            ...
            w = function() {
                var s, f, g, C, w, N, W, x, S, B, T, k, F, R, D, H, I, O, P, $ = /^img$/i,
                    j = /^iframe$/i,
                    ...
                    K = function(t, a) {
                        var i, n = t,
                            s = J(t);
                        for (x -= a, T += a, S -= a, B += a; s && (n = n.offsetParent) && n != e.body && n != r;)(s = (A(n, "opacity") || 1) > 0) && "visible" != A(n, "overflow") && (i = n.getBoundingClientRect(), s = B > i.left && S < i.right && T > i.top - 1 && x < i.bottom + 1);
                        return s
                    },
                    X = function() {
                        var t, a, o, l, d, u, c, g, m, y, v, h, z = i.elements;
                        if ((C = n.loadMode) && U < 8 && (t = z.length)) {
                            for (a = 0, V++; a < t; a++)
                                if (z[a] && !z[a]._lazyRace)
                                    if (!q || i.prematureUnveil && i.prematureUnveil(z[a])) nt(z[a]);
                                    else if ((g = z[a].getAttribute("data-expand")) && (u = 1 * g) || (u = Q), y || (y = !n.expand || n.expand < 1 ? r.clientHeight > 500 && r.clientWidth > 500 ? 500 : 370 : n.expand, i._defEx = y, v = y * n.expFactor, h = n.hFac, k = null, Q < v && U < 1 && V > 2 && C > 2 && !e.hidden ? (Q = v, V = 0) : Q = C > 1 && V > 1 && U < 6 ? y : 0), m !== u && (N = innerWidth + u * h, W = innerHeight + u, c = -1 * u, m = u), o = z[a].getBoundingClientRect(), (T = o.bottom) >= c && (x = o.top) <= W && (B = o.right) >= c * h && (S = o.left) <= N && (T || B || S || x) && (n.loadHidden || J(z[a])) && (f && U < 3 && !g && (C < 3 || V < 4) || K(z[a], u))) {
                                if (nt(z[a]), d = !0, U > 9) break
                            } else !d && f && !l && U < 4 && V < 4 && C > 2 && (s[0] || n.preloadAfterLoad) && (s[0] || !g && (T || B || S || x || "auto" != z[a].getAttribute(n.sizesAttr))) && (l = s[0] || z[a]);
                            l && !d && nt(l)
                        }
                    },
                    Y = (F = X, D = 0, H = n.throttleDelay, I = n.ricTimeout, O = function() {
                        R = !1, D = a.now(), F()
                    }, P = u && I > 49 ? function() {
                        u(O, {
                            timeout: I
                        ...
                        var e;
                        (t = !0 === t) && (I = 33), R || (R = !0, (e = H - (a.now() - D)) < 0 && (e = 0), t || e < 9 ? P() : l(P, e))
                    }),
                    Z = function(t) {
                        var e = t.target;
                        e._lazyCache ? delete e._lazyCache : (G(t), v(e, n.loadedClass), h(e, n.loadingClass), z(e, et), b(e, "lazyloaded"))
                    },
                    tt = _(Z),
                    et = function(t) {
                        tt({
                    ...
                    it = _(function(t, e, a, i, r) {
                        ...
                        (f = b(t, "lazybeforeunveil", e)).defaultPrevented || (i && (a ? v(t, n.autosizesClass) : t.setAttribute("sizes", i)), o = t.getAttribute(n.srcsetAttr), s = t.getAttribute(n.srcAttr), r && (d = t.parentNode, u = d && c.test(d.nodeName || "")), y = e.firesLoad || "src" in t && (o || s || u), f = {
                            target: t
                        }, v(t, n.loadingClass), y && (clearTimeout(g), g = l(G, 2500), z(t, et, !0)), u && m.call(d.getElementsByTagName("source"), at), o ? t.setAttribute("srcset", o) : s && !u && (j.test(t.nodeName) ? function(t, e) {
                    ...
                    nt = function(t) {
                        if (!t._lazyRace) {
                            var e, a = $.test(t.nodeName),
                                ...
                                r = "auto" == i;
                            (!r && f || !a || !t.getAttribute("src") && !t.srcset || t.complete || y(t, n.errorClass) || !y(t, n.lazyClass)) && (e = b(t, "lazyunveilread").detail, r && M.updateElem(t, !0, t.offsetWidth), t._lazyRace = !0, U++, it(t, e, r, i, a))
                        }
                    },
                    rt = L(function() {
                        n.loadMode = 3, Y()
                    ...
                    ot = function() {
                        f || (a.now() - w < 999 ? l(ot, 999) : (f = !0, n.loadMode = 3, Y(), o("scroll", st, !0)))
                    };
                return {
                    _: function() {
                        w = a.now(), i.elements = e.getElementsByClassName(n.lazyClass), s = e.getElementsByClassName(n.lazyClass + " " + n.preloadClass), o("scroll", Y, !0), o("resize", Y, !0), o("pageshow", function(t) {
                            if (t.persisted) {
            ...
            M = (x = _(function(t, e, a, i) {
                ...
                n && (a = C(t, n, a), (i = b(t, "lazybeforesizes", {
                    width: a,
                    dataAttr: !!e
                })).defaultPrevented || (a = i.detail.width) && a !== t._lazysizesWidth && x(t, n, i, a))
            }, B = L(function() {
                var t, e = W.length;
                if (e)
                    for (t = 0; t < e; t++) S(W[t])
                ...
                _: function() {
                    W = e.getElementsByClassName(n.autosizesClass), o("resize", B)
                },
                checkElems: B,
                updateElem: S
            }),
    ...
    jQuery(t.target).is("iframe") ? jQuery(t.target).parent().fitVids() : a && e ? t.target.style.backgroundImage = a + ",url(" + e + ")" : e && (t.target.style.backgroundImage = "url(" + e + ")")
...
jQuery(window).on("load", function() {
    function t(t) {
        var e, a;
        if (t instanceof jQuery.Event)(a = jQuery(t.target).closest("select")).length && a.closest(".avada-select-wrapper").length && r(a);
        else
            for (e = 0; e < t.length; e++) a = jQuery(t[e].target), "childList" === t[e].type && a.is("select") && a.closest(".avada-select-wrapper").length && r(a);

        function r(t) {
            t.closest("td.value").find(".avada-color-select, .avada-button-select, .avada-image-select").each(function() {
                var e = jQuery(this),
                    a = e.attr("data-value");
                t.find('[value="' + a + '"]').length ? e.removeAttr("data-disabled") : e.attr("data-disabled", !0)
            })
        }
    }
    jQuery(".avada-select-wrapper").each(function() {
        var t = jQuery(this).find("select").val(),
            e = jQuery(this).find('[data-value="' + t + '"]'),
            a = jQuery(this).find("[data-checked]");
        e.length && !e.is("[data-checked]") && (a.removeAttr("data-checked"), e.attr("data-checked", !0))
    }), jQuery("body").on("click", ".avada-color-select, .avada-image-select, .avada-button-select", function(t) {
        var e = jQuery(this).closest(".avada-select-wrapper"),
            a = e.find("select"),
            r = jQuery(this).attr("data-value");
        if (e.length && t.preventDefault(), !jQuery(this).attr("data-disabled")) {
            if (jQuery(this).is("[data-checked]")) return e.find("[data-checked]").removeAttr("data-checked"), void a.val("").trigger("change.wc-variation-form");
            e.find("[data-checked]").removeAttr("data-checked"), jQuery(this).attr("data-checked", !0), a.val(r).trigger("change.wc-variation-form")
        }
    }), window.MutationObserver ? new MutationObserver(t).observe(document.querySelector("body"), {
        attributes: !1,
        childList: !0,
        characterData: !0,
        subtree: !0
    }) : jQuery("body").on("DOMNodeInserted DOMNodeRemoved", t), jQuery("body").on("check_variations", ".variations_form", function(t) {
        var e = jQuery(t.currentTarget).closest(".product").find(".product_meta").find(".sku");
        1 < e.length && e.each(function() {
            void 0 === jQuery(this).attr("data-o-content-set") ? (jQuery(this).attr("data-o_content", jQuery(this).text()), jQuery(this).attr("data-o-content-set", !0)) : jQuery(this).closest(".fusion-layout-column").hasClass("post-card") && jQuery(this).text(jQuery(this).attr("data-o_content"))
        })
    }), jQuery("body").on("reset_data", ".variations_form", function(t) {
        var e = jQuery(t.currentTarget).closest(".product").find(".product_meta").find(".sku");
        1 < e.length && jQuery(e).each(function() {
            jQuery(this).closest(".fusion-layout-column").hasClass("post-card") && void 0 !== jQuery(this).attr("data-o_content") && jQuery(this).text(jQuery(this).attr("data-o_content"))
        })
    }), jQuery("body").on("click", ".reset_variations", function() {
        jQuery(".product").find(".product_meta").find(".sku").each(function() {
            void 0 !== jQuery(this).attr("data-o_content") && jQuery(this).text(jQuery(this).attr("data-o_content"))
...
jQuery(window).on("load", function() {
    ...
    var e, t, i, o, n, a;
    for (jQuery("body").on("click", ".add_to_cart_button.ajax_add_to_cart:not(.disabled)", function() {
            var e = jQuery(this).closest(".product, li, .swiper-slide"),
                t = e.find(".cart-loading"),
                i = !!e.hasClass("post-card") && e.find(".fusion-image-wrapper");
            i && i.addClass("hover"), t.find("i").removeClass("awb-icon-check-square-o").addClass("awb-icon-spinner"), t.fadeIn(), setTimeout(function() {
                t.find("i").hide().removeClass("awb-icon-spinner").addClass("awb-icon-check-square-o").fadeIn(), t.closest(".fusion-clean-product-image-wrapper, li").addClass("fusion-item-in-cart"), i && i.removeClass("hover")
            }, 2e3)
        }), jQuery("body").on("should_send_ajax_request.adding_to_cart", function(e, t) {
            return !jQuery(t).hasClass("disabled")
        }), jQuery("body").on("mouseenter mouseleave", ".products .product, .fusion-woo-slider .swiper-slide, .post-card.product", function(e) {
            var t = jQuery(this).find(".cart-loading");
            t.find("i").hasClass("awb-icon-check-square-o") && ("mouseenter" === e.type ? t.fadeIn() : t.fadeOut())
    ...
    t.indexOf("underline"), jQuery("body").hasClass("rtl") && (i = "title-heading-right"), jQuery(".woocommerce.single-product .related.products > h2").each(function() {
        jQuery(this).replaceWith(function() {
            return '<div class="fusion-title title' + t + '"><h' + avadaWooCommerceVars.related_products_heading_size + ' class="' + i + '">' + jQuery(this).html() + "</h" + avadaWooCommerceVars.related_products_heading_size + '><span class="awb-title-spacer"></span><div class="title-sep-container"><div class="title-sep' + t + ' "></div></div></div>'
        })
    }), jQuery(".woocommerce.single-product .upsells.products > h2").each(function() {
        jQuery(this).replaceWith(function() {
            return '<div class="fusion-title title' + t + '"><h3 class="' + i + '">' + jQuery(this).html() + '</h3><span class="awb-title-spacer"></span><div class="title-sep-container"><div class="title-sep' + t + ' "></div></div></div>'
        })
        ...
        var t, i = jQuery(".fusion-woocommerce-quick-view-overlay"),
            ...
            r = o.find(".fusion-wqv-preview-image"),
            s = o.find(".fusion-wqv-content"),
            ...
            p = f.find(".onsale"),
            y = f.find(".fusion-out-of-stock"),
            m = f.find(".product-title").length ? f.find(".product-title") : f.find(".fusion-rollover-title"),
            w = f.find(".fusion-price-rating").length ? f.find(".fusion-price-rating") : f.find(".price").first(),
            g = parseInt(h.height(), 10) / parseInt(h.width(), 10),
            v = {},
            j = !1,
            Q = !0,
            _ = "";
        e.preventDefault(), jQuery("body").addClass("fusion-wqv-open"), jQuery(".fusion-wqv-open").on("keydown", function(e) {
            ...
            "max-width": v.startWidth > v.endWidth ? "100%" : v.endWidth,
            "max-height": v.startWidth > v.endWidth ? "auto" : v.endHeight
        }), r.find("img").removeAttr("style"), setTimeout(function() {
            o.animate({
                top: v.endTop + "px",
                left: v.endLeft + "px",
                width: v.endWidth + "px",
                height: v.endHeight + "px"
            }, 800, "easeInOutCubic", function() {
                v.startWidth > v.endWidth && r.css({
                    "max-width": v.endWidth,
                    "max-height": v.endHeight
                })
            })
        }, 200), setTimeout(function() {
            o.animate({
                left: v.finalLeft + "px",
                width: v.finalWidth + "px"
            }, 600, "easeInOutCubic", function() {
                jQuery(this).addClass("complete"), jQuery(this).css("top", ""), jQuery(this).css("left", "")
            })
        }, 1e3), setTimeout(function() {
            d.fadeIn("300"), 40 > avadaWooCommerceVars.shop_page_bg_color_lightness && d.find("button").addClass("light"), j = !0, o.hasClass("fusion-quick-view-loaded") || (m.length && (u.find(".entry-title").html(m.text()), parseFloat(avadaWooCommerceVars.post_title_font_size) < parseFloat(u.find(".entry-title").css("font-size")) && u.find(".entry-title").css("font-size", parseFloat(avadaWooCommerceVars.post_title_font_size) + "px")), w.length && (u.find(".star-rating").show(), w.hasClass("fusion-price-rating") ? u.find(".fusion-price-rating").html(w.children().clone()) : (u.find(".fusion-price-rating .price").html(w.clone()), f.find(".star-rating").length && u.find(".fusion-price-rating .star-rating").html(f.find(".star-rating").first().html())), u.find(".star-rating").is(":empty") && u.find(".star-rating").hide()), u.css("left", "calc(100% - " + Math.round((v.finalWidth - v.endWidth) / 2) + "px)"), u.stop().fadeTo("300", "1"))
    ...
    jQuery(".catalog-ordering").find("a").each(function() {
        var t, i = jQuery(this).attr("href");
        if (void 0 !== i) {
            for (t of e.entries()) - 1 === i.indexOf(t[0]) && (i += "&" + t[0] + "=" + t[1]);
...
function avadaAddQuantityBoxes(t, a) {
    ...
    t || (t = ".qty"), a || (a = jQuery("div.quantity:not(.buttons_added), td.quantity:not(.buttons_added)").find(t)), a.length && (jQuery.each(a, function(t, a) {
        ...
        var a = jQuery(this).parent().find(t),
            ...
            u = a.attr("step");
        e && "" !== e && "NaN" !== e || (e = 0), "" !== o && "NaN" !== o || (o = ""), "" !== i && "NaN" !== i || (i = 0), "any" !== u && "" !== u && void 0 !== u && "NaN" !== parseFloat(u) || (u = 1), jQuery(this).is(".plus") ? o && (o == e || e > o) ? a.val(o) : a.val(e + parseFloat(u)) : i && (i == e || e < i) ? a.val(i) : 0 < e && a.val(e - parseFloat(u)), n && (jQuery(this).closest("tr").hasClass("opc_cart_item") || jQuery(this).closest(".shop_table").parent().hasClass("wcopc")) ? a.trigger("input") : a.trigger("change")
    })))
}
...
var avadaLiveSearchVars = {
    "live_search": "1",
    "ajaxurl": "https:\/\/tyrodimos.gr\/wp-admin\/admin-ajax.php",
    ...
    var e = this,
        i = {
            ...
            start: function(i) {
                ...
                }), jQuery(e.$el).closest("#sliders-container").length && jQuery(document.body).trigger("sticky_kit:recalc"), jQuery.isFunction(jQuery.fn.initElementAnimations) && jQuery(window).initElementAnimations()
            },
            before: function() {
...
function fusionGetStickyOffset() {
    ...
    return t.length ? (t.each(function() {
        ...
        t.closest("#side-header").length || t.closest(".off-canvas-content").length || i > e && (e = i)
    }), e) : e
}
...
function initSwiperScrollingSection(e) {
    ...
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (t.allowTouchMove = !0);
    ...
    e.find(".fusion-scroll-section-nav ul li a").on("click", function(e) {
        ...
        if (r.length) {
            t.preventDefault();
            let e = r.index();
            r.hasClass("fusion-container-anchor") && (e = r.parent().index()), n(o), i.slideTo(e)
        }
    })
}
...
function initScrollingSections(e) {
    ...
    e && (n = jQuery(".post-preview.post-content").find(".fusion-scroll-section")), n.hasClass("awb-swiper-full-sections") ? initSwiperScrollingSection(n) : (window.lastYPosition = 0, window.scrollDisabled = !1, n.length && (jQuery("#content").find(".non-hundred-percent-height-scrolling").length || 1 !== n.length || jQuery.trim(jQuery("#sliders-container").html()) || (n.addClass("active"), n.find(".fusion-scroll-section-nav li:first a").addClass("active"), t = !0), n.each(function() {
        ...
        var t = jQuery(this).parents(".fusion-scroll-section"),
            ...
            r = s.length ? parseInt(s.data("element"), 10) : 0,
            c = parseInt(jQuery(this).data("element"), 10),
            l = Math.abs(c - r);
        e.preventDefault(), 0 < l && (t.data("clicked", c), "fixed" !== n.last().css("position") && n.css({
            position: "fixed",
            top: i.sectionTopOffset,
            left: i.sectionLeftOffset,
            padding: "0",
            width: i.sectionWidth
        }), 1 === c ? jQuery(window).scrollTop(i.sectionTop + 1) : o === c ? jQuery(window).scrollTop(i.sectionBottom - i.viewportHeight - 1) : c > r ? jQuery(window).scrollTop(i.sectionTop + i.viewportHeight * c - 1) : jQuery(window).scrollTop(i.sectionTop + i.viewportHeight * (c - 1) + 1))
...
var avadaMenuVars = {
    ...
    "side_header_break_point": "1051",
    "megamenu_base_width": "viewport_width",
    "mobile_menu_design": "modern",
    "dropdown_goto": "\u039c\u03b5\u03c4\u03ac\u03b2\u03b1\u03c3\u03b7 \u03c3\u03b5 ...",
    "mobile_nav_cart": "\u039a\u03b1\u03bb\u03ac\u03b8\u03b9 \u0391\u03b3\u03bf\u03c1\u03ce\u03bd",
...
var avadaWooCommerceVars = {
    "order_actions": "\u039b\u03b5\u03c0\u03c4\u03bf\u03bc\u03ad\u03c1\u03b5\u03b9\u03b5\u03c2",
    "title_style_type": "",
    "woocommerce_shop_page_columns": "4",
    "woocommerce_checkout_error": "\u0394\u03b5\u03bd \u03ad\u03c7\u03b5\u03c4\u03b5 \u03c3\u03c5\u03bc\u03c0\u03bb\u03b7\u03c1\u03ce\u03c3\u03b5\u03b9 \u03c4\u03b1 \u03b1\u03c0\u03b1\u03c1\u03b1\u03af\u03c4\u03b7\u03c4\u03b1 \u03c0\u03b5\u03b4\u03af\u03b1",
...
jQuery(window).on("load", function() {
    ...
    jQuery('.fusion-update-cart, a[href="#updateCart"]').on("click", function(e) {
        ...
        setTimeout(function() {
            jQuery("#" + e).find(".awb-carousel").length && "function" == typeof generateSwiperCarousel && generateSwiperCarousel(), jQuery("#" + e).find(".fusion-gallery").each(function() {
                jQuery(this).isotope()
...
! function(e) {
    ...
    e.fn.fusion_scroll_to_anchor_target = function(t) {
        var n, o, s, i, a, l, r, c, u, h, f, d, p = void 0 !== e(this).attr("href") ? e(this).attr("href") : e(this).data("link"),
        ...
        if (t = void 0 !== t ? t : 0, m.length && "" !== g) {
            ...
            if ((m.parents(".hundred-percent-height-scrolling").length || m.find(".hundred-percent-height-scrolling").length) && (0 != fusionScrollToAnchorVars.container_hundred_percent_height_mobile || !Modernizr.mq("only screen and (max-width: " + fusionScrollToAnchorVars.content_break_point + "px)"))) {
                ...
                if (location.hash && "#_" === location.hash.substring(0, 2) && e(".fusion-page-load-link").addClass("fusion-page.load-scroll-section-link"), m.parents(".fusion-scroll-section").length) return m.parents(".fusion-scroll-section").hasClass("active") ? m.parents(".fusion-scroll-section").find(".fusion-scroll-section-nav").find(".fusion-scroll-section-link[data-element=" + d.data("element") + "]").trigger("click") : (f = Math.ceil(m.parents(".fusion-scroll-section").offset().top), e(y).animate({
                    scrollTop: f
                }, {
                    duration: 400,
                    easing: "easeInExpo",
            ...
            return m.parents(".awb-off-canvas").length ? 0 !== m.parents(".awb-off-canvas-wrap.awb-show").length && (r = (l = m.parents(".awb-off-canvas-wrap.awb-show").find(".off-canvas-content"))[0].getBoundingClientRect().top, c = m[0].getBoundingClientRect().top, u = l.scrollTop(), i = c < r ? u - (r - c) : Math.abs(u + (c - r)), h = l[0].scrollHeight - l.outerHeight(), i > h && (i = h), void l.animate({
                scrollTop: i
            }, {
                duration: 400
            })) : (n = fusion.getAdminbarHeight(), s = e(document).scrollTop(), b ? (e("body").addClass("fusion-scrolling-active"), (w = fusionGetStickyOffset()) || (w = n), i = m.offset().top - w - t) : (o = "function" == typeof getStickyHeaderHeight ? getStickyHeaderHeight() : 0, i = m.offset().top - n - o - t), a = Math.abs(s - i) / 2, f = s > i ? s - a : s + a, e(y).animate({
                scrollTop: f
            }, {
                duration: 400,
                easing: "easeInExpo",
    ...
    jQuery("body").on("click", '.fusion-menu a:not([href="#"], .fusion-megamenu-widgets-container a, .search-link), .fusion-widget-menu a, .fusion-secondary-menu a, .fusion-mobile-nav-item a:not([href="#"], .search-link), .fusion-button:not([href="#"], input, button), .fusion-one-page-text-link:not([href="#"]), .fusion-content-boxes .fusion-read-more:not([href="#"]), .fusion-imageframe > .fusion-no-lightbox, .content-box-wrapper:not(.link-area-box) .heading-link, a.woocommerce-review-link, .awb-toc-el .awb-toc-el__item-anchor', function(e) {
        var t, n, o, s, i, a, l, r = jQuery("body").hasClass("fusion-builder-live");
